...
lib.ssMetadata = [
		{name:"1280x418_atlas_1", frames: [[0,919,141,38],[0,840,389,77],[0,0,752,418],[0,420,561,418]]}
];
...
p.nominalBounds = new cjs.Rectangle(0,0,752,418);
...
p.nominalBounds = new cjs.Rectangle(0,0,389,77);
...
p.nominalBounds = new cjs.Rectangle(0,0,141,38);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-79.5,282,1,1,0,0,0,70.5,19);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(44).to({_off:false},0).to({x:270.5},15,cjs.Ease.get(1)).wait(181));

	// Layer_2
	this.instance_1 = new lib.Symbol41("synched",0);
	this.instance_1.setTransform(271.5,192.5,1,1,0,0,0,194.5,38.5);
	this.instance_1.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({y:202.5,alpha:1},29,cjs.Ease.get(1)).wait(211));
	...
	this.instance_3.setTransform(904,209,1,1,0,0,0,376,209);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({regX:376.1,regY:208.8,scaleX:1.0665,scaleY:1.0665,x:904.1,y:208.9},239).wait(1));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(490,195.1,815,236.9);
// library properties:
lib.properties = {
